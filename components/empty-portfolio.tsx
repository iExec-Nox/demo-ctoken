...
export function EmptyPortfolio() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center rounded-[32px] border border-surface-border bg-surface px-10 py-24 backdrop-blur-sm">
      <div className="flex flex-col items-center gap-[29px]">
        ...
        <Link
          href="/faucet"
          className="flex cursor-pointer items-center gap-2 rounded-xl bg-primary px-5 py-3 font-mulish text-lg font-bold text-primary-foreground shadow-[0px_2px_4px_0px_rgba(71,37,244,0.4)] hover:bg-primary-hover"
        >
