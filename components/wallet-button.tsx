...
export function WalletButton() {
  ...
  return (
    <button
      onClick={() => open()}
      className="rounded-lg border border-[rgba(112,136,255,0.1)] bg-primary px-6 py-2 font-mulish text-sm font-bold text-white transition-colors hover:bg-primary-hover"
    >
      Connect Wallet
    </button>
  );
