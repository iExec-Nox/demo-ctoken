...
const FEATURES = [
  {
    ...
    description: 'Works seamlessly across existing and future DeFi ecosystems.',
  },
  {
    icon: '/feature-icon.svg',
  ...
  return (
    <section className="flex w-full flex-col items-center gap-10 py-10 md:py-[60px] lg:py-16">
      <div className="flex flex-col items-start gap-5 px-10 md:items-center md:px-20 lg:px-40">
        <h2 className="font-mulish text-text-heading md:font-anybody text-[28px] leading-normal font-bold md:text-[32px] md:leading-[1.2]">
          The Next Evolution of DeFi Is Confidential
        </h2>
        <p className="font-mulish text-text-body text-base leading-[1.6] md:text-lg">
          Confidential Token removes transparency as a barrier to institutional
          adoption.
        </p>
      </div>
