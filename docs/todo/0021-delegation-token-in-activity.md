...
Utiliser le subgraph existant (TODO-0019) : l'entité `Handle` a un champ `operator` qui identifie le type d'opération, et le DAG parent/child permet de remonter au contrat token source.

| Avantage | Inconvénient |
|----------|-------------|
| 100% fiable, y compris historique | Dépend de la migration subgraph (TODO-0019 Phase 2) |
...
- Dépend de : rien
- Lié à : TODO-0019 (subgraph — solution long-terme Option C)
